            ...
            <div className="blog_details">
              ...
              <div className="blog_publisher d-flex align-items-center gap-4 mb-4">
                ...
                <span className="d-flex align-items-center gap-1 section_description">
                  <i class="ri-calendar-line" className='calc' ></i>{blog.date}
                </span>
            ...
            <div className="comment_lis mt-5">
              ...
              <div className="single_comment d-flex gap-3" >
                ...
                <div className="comment_content">
                  ...
                  <p className="section_description ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem illum ratione mollitia blanditiis consequuntur dicta odio eligendi, voluptates harum error maiores tempore assumenda incidunt natus sit atque cupiditate dolor magni!</p>
              ...
              <div className="leave_comment-form mt-5">
                ...
                <Form>
                  ...
                  <button className='comment_btn  mt-3'>Post a Comment</button>
                </Form>
              </div>
            </div>
          </Col>
